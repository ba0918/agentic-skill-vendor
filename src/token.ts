...
export function readStandardInput(): string {
  ...
  try {
    ...
    // The cause is described rather than the value: nothing was successfully
    // read, but a partial read reported back would be a fragment of a
    // credential in an error message.
    throw new ConfigError(
